...
def health_check():
    ...
    try:
        ...
        return APIResponse.success(health_data, "API is healthy")
...
def get_tasks():
    ...
    try:
        ...
        return APIResponse.success(tasks_data, f"Retrieved {len(tasks)} tasks")
...
def get_task(task_id):
    ...
    try:
        ...
        return APIResponse.success(task.to_dict(), "Task retrieved successfully")
...
def send_email_reminder(task_id):
    ...
    try:
        ...
        if not recipient_email:
            return APIResponse.error("Recipient email is required", 400)
...
def export_to_sheets():
    ...
    try:
        ...
        return APIResponse.error("Failed to export to sheets", 500)
...
def add_to_calendar(task_id):
    ...
    try:
        ...
        return APIResponse.error("Failed to add to calendar", 500)
...
def get_integration_status():
    ...
    try:
        ...
        return APIResponse.success(integrations, "Integration status retrieved")
...
def batch_email_reminders():
    ...
    try:
        ...
        return APIResponse.error("Failed to send batch reminders", 500)
...
def get_dashboard():
    ...
    try:
        ...
        return APIResponse.success(dashboard_data, "Dashboard data retrieved successfully")
